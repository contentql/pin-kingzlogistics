import approch_img from '@styles/assets/img/approach/approch-img.jpg'
          ...
          <div className='col-lg-6'>
            <div
              ...
              <div className='approach__text'>
                ...
                <ul>
                  <li>
                    <i className='fal fa-check-circle'></i>Commercial expertise
                  </li>
                  <li>
                    <i className='fal fa-check-circle'></i>Logistical expertise
                  </li>
                  <li>
                    <i className='fal fa-check-circle'></i>Sustainability goals
                  </li>
                  <li>
                    <i className='fal fa-check-circle'></i>Cost Optimization
                  </li>
                  <li>
                    <i className='fal fa-check-circle'></i>Reduce Transit Time
                  </li>
                  <li>
                    <i className='fal fa-check-circle'></i>Managing Logistics
                  </li>
                </ul>
              </div>
            </div>
