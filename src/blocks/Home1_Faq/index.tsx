...
import { Home1_Faq as Home1_Faq_Type } from '@payload-types'
...
const Home1_Faq: React.FC<Home1_Faq_Type> = data => {
  const accordion_data = [
    {
      ...
      description:
        'From finance, retail, and travel, to social media, cybersecurity, adtech,and more, market leaders are leveraging web data to maintain their transtadvantage. Discover how it can work for you.',
    },
    {
      id: 2,
      id_2: 'headingTwo',
                    ...
                    <div className='accordion-item' key={item.id}>
                      <h2 className='accordion-header'>
                        <button
                          ...
                          data-target={item.data_base_target}
